...
function showcaseCopy(locale) {
  const copy = {
    ...
    ru: {
      missionTitle: "??????? ?????????? ????????????",
      missionText: "???? ???? - ????????? ???? ? ??????: ?? ?????????, ??? ??? ????????, ??? ???? beta ? ?????? ??????????? ???????? open-source.",
      statusTitle: "??????? ?????? ???????",
      statusText: "MIDI Piano Trainer ??? ????????. Audio-to-MIDI ???? beta. Open Transcription Studio ???????????? ??? ????????? ??????? ??????????. ???????????? ?????? ?????? ???? ?????? ??? ?????? ????????.",
      whyTitle: "?????? ??? ?????",
      whyText: "???????? creative-??????????? ????? ?????? ? ????????. Open Free Tools ????????? ???????? workflow ??????????, ?????? ?????????? ??????????? ? ????????? ??????? ??? self-host ???????.",
      monetizationTitle: "??? ?????? ????? ?????????",
      monetizationText: "??????????? ???? ????? ??????, ?????????, ??????? ????? ???????? ? ?????????? ??????? ?? ?????????? ?????????. ??????? ?? ?????? ?????? ???????? ?????????? ????????????.",
      roadmapTitle: "Roadmap",
      roadmap: ["??????? hub ??????????? ????????????? ????????.", "??????? MIDI Piano Trainer ? beta Audio-to-MIDI workflow.", "??????? ???????? SEO-????? ?? ?????? ? AdSense.", "??????????? feedback-first ????????? ??? Reddit, Discord, ???????? ?????, GitHub, Show HN, Product Hunt ? AlternativeTo.", "??????? Open Transcription Studio ??? ????????? ??????? ??????????."],
      earlyTitle: "?????? ????????????",
      earlyText: "?????? ???????????? ?????? ?????? ?? ??????? ????????? ? ???????? ????, ? ?? ?????? ?? Google. ?????? ?????? ?????? ??????? feedback, ?????????? ????????? ? ?? ????????? ??? ????.",
      toolsTitle: "??????? ? ??????? ???????????",
      toolsText: "??????? ?????????? ???????, beta ? ??????????????? ???????????, ????? ???????????? ????? ????? ?????????? ???????.",
      rulesTitle: "??????? ???????",
      rulesText: "Core-??????? ???????? ??????????? ? open-source. ?????? ?? ???????? ??????, ????????, UI, ??????, private API ? ?????????? ????????? ??????? ????????.",
      hostingTitle: "?????? ? ????????",
      hostingText: "???????????? ??????????? ??????? ? ????????? ? ????????. Backend ???????????? optional ?????? ???, ??? ??????? ????????? ?????? ??????? ??????? ????????.",
      communityTitle: "?????? ? ???????????",
      communityText: "?????? ?????? ????? ????? feedback, GitHub issues, ???????? ?????, ???????? ???? ? ??????? ????? ? ??????????? ???????????.",
      contentTitle: "???????-?????????",
      contentText: "????? ?????? ?????? ???????? ??????: ??????????? ????? ? MIDI, ?????????? MIDI-??????, ????? ?????????? ???????????? ? privacy-friendly workflow.",
      launchKitTitle: "Launch kit",
      launchKitText: "??? ??????? ??????????? ????? ???????? pitch, screenshots/video, ?????? ??? ?????????, feedback issue ? release note.",
      adsTitle: "?????????? ?????????? ???????",
      adsText: "??????? ???????? ??? ??????, landing pages ? comparison content. ?? ?????? ??????? ????? ? Upload, Play, Convert, Download ??? ??????????.",
      statusStable: "????????",
      statusBeta: "beta",
      statusPlanned: "?????????????",
      openPage: "??????? ????????",
    ...
    hy: {
      ...
      statusText: "MIDI Piano Trainer-? ????? ???????? ?: Audio-to-MIDI-? beta ?: Open Transcription Studio-? ?????????? ? ????? ??????? ????? ??????:",
      whyTitle: "????? ? ?? ???????",
      whyText: "??????? ?????????????? ?????????? ????? ??????? ?? ??????????????????: Open Free Tools-? ?????? ? ???????? workflow-? ??????, ???? ????????? ? ????????????????? ?? ????? ? ????? fork ??? self-host:",
      monetizationTitle: "?????? ????? ? ???????? ?????????????",
      monetizationText: "???????? ????? ? ?????????? ??????????????????, sponsors, ??????? ????????? ???????????? ?? ???????? ?????? content ???????: ??????? ????? ? ??????? ??????? ???????????:",
      roadmapTitle: "Roadmap",
      roadmap: ["????? hub-? ????? ?????????? ?????????? ???????:", "????????? MIDI Piano Trainer-? ?? beta Audio-to-MIDI workflow-?:", "??????? ??????? SEO ???????????? AdSense-?? ????:", "????????? feedback-first ??????? Reddit-?, Discord-?, ???? ????????????, GitHub-?, Show HN-?, Product Hunt-? ?? AlternativeTo-? ?????:", "??????? Open Transcription Studio-? ????? ??????? ????? ??????:"],
      earlyTitle: "?????? ??????????",
      earlyText: "?????? ?????????? ???? ? ??? ?????????? ???????????? ?? ???? demo-?????, ?? ????? Google-??: ???? ??????????? ???? ? ????? feedback, ????????? ??????????????? ?? ????? spam:",
      toolsTitle: "????? ?? ?????????? ?????????",
      toolsText: "???????? ????? ? ????? ???????, beta ?? ?????????? ??????????, ??????? ??????? ???????????? ????? ????:",
      rulesTitle: "??????? ????????",
      rulesText: "???????? ???????????? ????? ?? ?????? ?? open-source: ???????? ?? ????????????? ??????? ???????????????? brands, logos, UI, assets, private APIs ??? protected behavior:",
      hostingTitle: "Hosting ????????",
      hostingText: "?????????? ??? static hosting ?? browser-side processing: Backend-? optional ? ????? ??? ?????????, ??? ???? ????????? ???????? ?? ??????? ???? browser-???:",
      communityTitle: "??????????? ????????",
      communityText: "???????? ???? ? ??? feedback-?, GitHub issues-?, ??????? guides-?, ???? demo-???? ?? ????? community posts-? ???????:",
      contentTitle: "Content strategy",
      contentText: "Guides-? ???? ? ?????? ?????? ????????? audio to MIDI, MIDI practice, ?????? ?????????? ??????????? ?? privacy-friendly workflows:",
      launchKitTitle: "Launch kit",
      launchKitText: "????????????? ??????? ????? ???? ?? short pitch, screenshots ??? video, community post drafts, feedback issue ?? release note:",
      adsTitle: "AdSense-safe ??????",
      adsText: "??????? ???? ? ???? guides-?, landing pages-? ?? comparison content-? ???: ??? ????? ? ???? Upload, Play, Convert, Download ??? editor controls-? ??????:",
      statusStable: "???????? ?",
      statusBeta: "beta",
      statusPlanned: "??????????",
      openPage: "????? ???",
...
function toolCopy(route, locale) {
  ...
  const labels = {
    ...
    ru: {
      tryMidi: "??????? MIDI Piano Trainer",
      tryAudio: "??????? Audio-to-MIDI",
      roadmap: "??????? roadmap",
      what: "??? ???",
      current: "??? ????",
      next: "?????????",
      ...
      transcriptionStatus: "??????????????? ??????????",
      midiText: "?????????? ???????? ???????: ???????????? ????????? MIDI-????, ????? ???????? ????, ??????? ???? ??????? ? ?????? ?? ?????????? ??.",
      audioText: "Beta-????????? ????????????????? piano-?????. ????????? ???????? ????????????? ?????????? ??????????? backend, ? ????????? ????? ??????? ??? ??????? ? ?????????.",
      transcriptionText: "??????? open-source ???????? ???????????? ??? ????? ? ????? ? privacy-first ???????? ? ????????? ?????????.",
      midiCurrent: ["???????? MIDI ? ????????", "???????? ????", "????? ???????", "????????????? MIDI", "????????????? ????????"],
      audioCurrent: ["???????? ?????? ?????", "?????????????? ??????????? backend", "???????? ?????? ? ????????", "?????????? MIDI", "???????? MIDI ? ?????????"],
      transcriptionCurrent: ["Roadmap-????????", "?????????? ?????????? ????????????????", "????????? ??????? ??????", "??????????? ??????? TXT/SRT/VTT"],
      midiNext: ["???????? demo-?????????", "??????????? launch kit", "??????? ? SEO-???????", "??????? feedback ?????? ?????????????"],
      audioNext: ["???????? ???????? ?????????????", "???????? troubleshooting", "???????? ??????? ???????? ????????? ?????", "??????????? ???????? demo video"],
      transcriptionNext: ["??????? MVP", "??????? local-first ??????", "?? ?????????? ????? ??? UI ??????? ????????", "??????? ????????? ??????"],
    },
    de: {
    ...
    hy: {
      ...
      audioStatus: "Beta ??????",
      transcriptionStatus: "?????????? ??????",
      midiText: "Browser piano trainer. ???????? ??????? ? MIDI ????, ??????? ? ?????? ????????, ????? ? piano sound-? ?? ??????? PC keyboard-??:",
      audioText: "Beta converter ??????? piano audio-? ?????: ???????? ??? ??????? ??????????? ? official backend-?, ???? ????? ? ????? ????????? MIDI ??? ????? trainer-???:",
      transcriptionText: "????? open-source transcription editor audio ?? video-? ?????? privacy-first workflow-?? ?? subtitle export-??:",
      midiCurrent: ["MIDI ??????? browser-???", "?????? ???????", "Track selection", "MIDI ????", "?????????? ????"],
      audioCurrent: ["??????? audio upload", "??????? official backend", "????? limits ?? ???????", "MIDI download", "????? MIDI-? trainer-???"],
      transcriptionCurrent: ["Roadmap ??", "???????? ??????? positioning", "??????? ????? ???????", "?????????? TXT/SRT/VTT export"],
      midiNext: ["????????? demo ???????", "????????? launch kit", "????? SEO guides-? ???", "??????? ?????? feedback-?"],
      audioNext: ["???????? ???????? ?????", "????????? troubleshooting", "????? ??? ??? audio ?????????", "????????? ???? demo video"],
      transcriptionNext: ["???????? MVP", "?????? local-first ????????", "????????????? paid service brand ??? UI", "??????? ??????? ???????"],
    },
  };
