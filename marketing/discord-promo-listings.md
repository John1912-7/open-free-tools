# Discord Promo Listings

Track public Discord server directory submissions for the Open Free Tools community.

## Server

- Server name: `Study music`
- Server ID: `1521501520720298044`
- Public invite: `https://discord.gg/j7fqqET2Wv`
- Main audience: musicians, piano learners, MIDI users, open-source builders, and early Audio-to-MIDI testers.

## Listing Copy

Short description:

Free open-source music tools community. Test MIDI Piano Trainer, try the experimental Audio-to-MIDI converter, and help improve note/timing quality with real feedback.

Long description:

Open Free Tools is a free open-source music tools community. We are starting with MIDI Piano Trainer and an experimental Audio-to-MIDI converter: upload MIDI files, practice with falling notes, test piano audio conversion, and help improve the project with real feedback.
...
- Do not mass-submit identical spammy text into low-quality directories.
- Prefer directories that allow honest category/tag targeting.
- Use the public invite to `#welcome`.
- Do not authorize unnecessary permissions without user approval.
- Do not use paid promotion yet.
- Record every submitted listing and any required bump schedule here.
